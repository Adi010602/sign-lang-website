...
if app_mode =='About App':
    ...
    st.markdown('In this application we are using **MediaPipe** for detecting Sign Language. **SpeechRecognition** Library of python to recognise the voice and machine learning algorithm which convert speech to the Sign Language .**StreamLit** is to create the Web Graphical User Interface (GUI) ')
    st.image('https://d.newsweek.com/en/full/584462/04-28-signlanguage-01.jpg?w=1600&h=1600&q=88&f=d0d08f655660b14975878717f85ff3eb')
    st.markdown(
    """
    <style>
    [data-testid="stSidebar"][aria-expanded="true"] > div:first-child {
    ...
    text = st.text_input("Enter text here", "What to Translate...")
